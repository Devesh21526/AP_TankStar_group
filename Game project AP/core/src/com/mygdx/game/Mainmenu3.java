...
public class Mainmenu3 implements Screen {
    ...
    public Mainmenu3(final MyGdxGame game){
        this.game=game;
    ...
    public void tanksn2(){
        Mainmenu mn2=new Mainmenu(game);
        game.setScreen(mn2);
    }
    ...
    public void render(float delta) {
        ...
        game.batch.draw(t3.tankimg,68,70,200,200);
        if(Gdx.input.isTouched()&&((Gdx.input.isTouched()&&Gdx.input.getX() > 33 && Gdx.input.getX()<58) && (Gdx.input.getY()>291 && Gdx.input.getY()<322)) ){
            this.tanksn();
        ...
        if(Gdx.input.isTouched()&&(Gdx.input.isTouched()&&Gdx.input.getX() > 337 && Gdx.input.getX()<512) && (Gdx.input.getY()>61 && Gdx.input.getY()<109) ){
            this.Startgame();
        }
